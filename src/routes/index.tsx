...
export default function Home() {
  const { currentPlaylist, currentSong, isPlaying, togglePlayPause } = usePlayer();

  return (
    <main className="flex-1 p-10 bg-gradient-to-br from-[#0d0d1a] via-[#1a0f2e] to-[#0a0a1f] text-white">
      
      {/* Top section: Left text + Right Universal Playbar */}
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 mb-14">
        ...
        {/* Right: Universal Playbar */}
        <div
          onClick={togglePlayPause}
          className="w-72 h-80 bg-black/40 backdrop-blur-lg rounded-2xl p-6 border border-white/10 shadow-[0_0_25px_rgba(0,255,255,0.3)] hover:scale-105 transition cursor-pointer flex flex-col items-center justify-center"
        >
          <div className="w-36 h-36 mx-auto mb-6 rounded-full bg-gradient-to-tr from-pink-500 via-purple-500 to-cyan-400 shadow-[0_0_20px_rgba(255,0,255,0.8)] flex items-center justify-center text-4xl">
            {isPlaying ? "⏸" : "▶"}
          </div>
